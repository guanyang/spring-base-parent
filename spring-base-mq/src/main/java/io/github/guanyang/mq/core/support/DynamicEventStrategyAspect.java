...
import static io.github.guanyang.mq.core.support.AbstractEventAnnotationMethodProcessor.uniqueKey;
...
public class DynamicEventStrategyAspect implements BeanFactoryPostProcessor {
    ...
    public void postProcessBeanFactory(ConfigurableListableBeanFactory beanFactory) throws BeansException {
        Map<String, EventAnnotationMethodProcessor> processorMap = beanFactory.getBeansOfType(EventAnnotationMethodProcessor.class);
        ...
        processorMap.forEach((processorBeanName, methodProcessor) -> {
            ...
            beanFactory.autowireBean(advisor);
            beanFactory.registerSingleton(beanName, advisor);
            advisorBeanMap.put(beanName, beanFactory.getBean(beanName));
        });
